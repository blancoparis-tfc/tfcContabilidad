		...
		return new Properties() {
			{
				...
				setProperty("hibernate.hbm2ddl.import_files","/META-INF/inicializar.sql,/META-INF/paises.sql,/META-INF/comunidades.sql,/META-INF/provincias.sql,/META-INF/municipios.sql");
			}
		};
	}
